package webServerHomework.server;
...
import webServerHomework.servlet.*;

import java.util.Arrays;

public class HomeworkWebServer implements UsersWebServer {
    ...
    public HomeworkWebServer(int port,
    ...
    protected Handler applySecurity(ServletContextHandler servletContextHandler, String... paths) {
        servletContextHandler.addServlet(new ServletHolder(new ClientsLoginServlet(templateProcessor, authService)), "/login");
